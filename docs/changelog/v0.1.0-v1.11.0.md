# Changelog archive — v0.1.0 … v1.11.0

Moved here verbatim from [CHANGELOG.md](../../CHANGELOG.md) on 2026-09-26 so the root file
stays small. Each release's notes are also on its GitHub Release.
